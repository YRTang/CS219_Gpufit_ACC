...
GPUData::GPUData(Info const &info) : chunk_size_(0),
                                     info_(info),

                                     data_(
                                         (info_.data_location_ == HOST)
                                             ? info_.max_chunk_size_ * info_.n_points_
                                             : 0),
                                     weights_(
                                         (info_.use_weights_ && info_.data_location_ == HOST)
                                             ? info_.n_points_ * info_.max_chunk_size_
                                             : 0),
                                     parameters_(
                                         (info_.data_location_ == HOST)
                                             ? info_.max_chunk_size_ * info_.n_parameters_
                                             : 0),
                                     user_info_(
                                         (info_.data_location_ == HOST)
                                     ...
                                     constraints_(
                                         info_.use_constraints_
                                             ? info_.max_chunk_size_ * info_.n_parameters_ * 2
                                             : 0),
                                     constraint_types_(
                                         info_.use_constraints_
                                             ? info_.n_parameters_
...
void GPUData::point_to_data_sets()
{
    ...
    threads.x = static_cast<unsigned int>(std::min(info_.max_chunk_size_, max_threads));
    blocks.x = static_cast<unsigned int>(std::ceil(REAL(info_.max_chunk_size_) / REAL(threads.x)));
