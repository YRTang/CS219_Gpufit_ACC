#ifndef CAHNNEL_EQ_CUH_INCLUDED
#define CAHNNEL_EQ_CUH_INCLUDED
...
__device__ void calculate_channel_eq (               // ... = function name
    ...
    std::size_t const user_info_size)
{
    ...
    value[point_index] = p[0] * ex + p[4];  // formula calculating fit model values

    /////////////////////////// derivative ///////////////////////////

    REAL * current_derivative = derivative + point_index;

    current_derivative[0 * n_points] = ex;  // formula calculating derivative values with respect to parameters[0]
