    ...
    std::size_t const user_info_size)
{
    ...
    case MLE:
        ...
        break;
    case LSE_COMPLEX:
        calculate_chi_square_lse_complex(chi_square, point_index, data, value, weight, state, user_info, user_info_size);
        break;
    default:
    ...
    std::size_t const user_info_size)
{
    ...
    case MLE:
        ...
        break;
    case LSE_COMPLEX:
        calculate_gradient_lse_complex(gradient, point_index, parameter_index, data, value, derivative, weight, user_info, user_info_size);
        break;
    default:
        assert(0); // unknown estimator ID
    }
    ...
    std::size_t const user_info_size)
{
    ...
    {
    case LSE:
        calculate_hessian_lse(hessian, point_index, parameter_index_i, parameter_index_j, data, value, derivative, weight, user_info, user_info_size);
        break;
    case MLE:
        calculate_hessian_mle(hessian, point_index, parameter_index_i, parameter_index_j, data, value, derivative, weight, user_info, user_info_size);
        break;
    case LSE_COMPLEX:
        calculate_hessian_lse_complex(hessian, point_index, parameter_index_i, parameter_index_j, data, value, derivative, weight, user_info, user_info_size);
        break;
    default:
        assert(0); // unknown estimator ID
    }
